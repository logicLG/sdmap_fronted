  ...
  export default {
    ...
    methods: {
      getconnectionData() {
        // debugger;
        let that = this;
        that.$axios.get(that.$URL.opURL+"?start="+this.value1[0].getTime() + "&end="+this.value1[1].getTime(),
          {
          ...
          if (res.status == "ok") {
            ...
            for(let item of that.tableData.data){
              ...
              // date.getFullYear() +"年" + date.getUTCMonth() + "月" + date.getUTCDay()+"日"+ date.getHours()+"时";
            }
